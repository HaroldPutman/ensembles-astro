...
We need to prevent any way to complete CC/paypal Payment and then not get registered. To this when the user gets to the payment page we tag the registration with a payment_pending_at timestamp. Any class with this 
